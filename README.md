<h1 align="center">Alfred Toupie (previous Alfred OnePee)</h1>
...
currently there's no way to ping Passwords' passwords/URLs etc. there's no API.
...
so the idea with OnePee is to launch login URLs from Alfred and get macOS and Apple Passwords to automatically prepare the prompts for us. smooth and flawless whether you use passwords and OTPs, or passkeys.
